...
file=pd.read_excel(r"D:\Analytics in Agri\project\banaskatha_wheate.xlsx")
...
print('Variance score of test data: %.2f' % r2_score(y_test, y_pred))
error_test=mean_squared_error(y_test, y_pred)
print("error test : ",error_test)
plt.plot(y_pred,'r-*')
plt.plot(y_test,'b-^')
plt.gca().legend(('Yield predicted','Yield Actual'))
